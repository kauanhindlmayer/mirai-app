...
declare global {
  ...
  // @ts-ignore
  export type { BurndownPoint, BurnupPoint, DashboardResponse } from './src/types/dashboard'
  // @ts-ignore
  export type {
    PaginatedList,
    PaginationFilter,
  ...
  // @ts-ignore
  export type { CreateOrganizationRequest, Organization } from './src/types/organization'
  // @ts-ignore
  ...
  // @ts-ignore
  export type { BacklogLevel, BacklogResponse, CreateTeamRequest, Team } from './src/types/team'
  // @ts-ignore
  export type {
    LoginUserRequest,
    LoginUserResponse,
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly getJobStatusSeverity: UnwrapRef<
      (typeof import('./src/utils/tag'))['getTagImportJobStatusSeverity']
    >

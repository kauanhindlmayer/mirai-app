...
declare global {
  ...
  const createTagImportJob: typeof import('./src/api/tag-import-jobs')['createTagImportJob']
  ...
  const getTagImportJobStatusSeverity: (typeof import('./src/utils/tag'))['getTagImportJobStatusSeverity']
  ...
  const listTagImportJobs: typeof import('./src/api/tag-import-jobs')['listTagImportJobs']
...
declare global {
  ...
  // @ts-ignore
  export type { Board, BoardSummary, Column, Card, Assignee, CreateBoardRequest, MoveCardRequest, DraggableEvent, CreateBoardColumnRequest } from './src/types/board'
  ...
  // @ts-ignore
  export type { ShortcutCategory, RequestConfig, PaginatedList, HateoasResponse, Link, PaginationFilter, Shortcut } from './src/types/index'
  import('./src/types/index')
  // @ts-ignore
  export type { Preset, Primary, Surface, MenuMode, MenuTheme, CardStyle, ColorType, LayoutConfig, LayoutState, Color, Breadcrumb } from './src/types/layout'
  ...
  // @ts-ignore
  export type { Persona, PersonaBriefResponse, CreatePersonaRequest, UpdatePersonaRequest } from './src/types/persona'
  import('./src/types/persona')
  // @ts-ignore
  export type { Project } from './src/types/project'
  import('./src/types/project')
  // @ts-ignore
  export type { ProcessTemplate, Retrospective, RetrospectiveSummary, RetrospectiveColumn, RetrospectiveItem } from './src/types/retrospective'
  import('./src/types/retrospective')
  // @ts-ignore
  export type { CreateSprintRequest, Sprint } from './src/types/sprint'
  import('./src/types/sprint')
  // @ts-ignore
  export type { TagImportJobStatus, Tag, TagImportJob, CreateTagRequest, UpdateTagRequest } from './src/types/tag'
  ...
  // @ts-ignore
  export type { User, RegisterUserRequest, LoginUserRequest, LoginUserResponse, UpdateUserProfileRequest } from './src/types/user'
  import('./src/types/user')
  // @ts-ignore
  export type { WikiPage, WikiPageSummary, WikiPageStats, Comment, Author, CreateWikiPageRequest, UpdateWikiPageRequest, MoveWikiPageRequest, AddCommentRequest, UpdateCommentRequest } from './src/types/wiki-page'
  import('./src/types/wiki-page')
  // @ts-ignore
  export type { WorkItemStatus, WorkItemType, WorkItem, TagBriefResponse, WorkItemsStats } from './src/types/work-item'
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly ProcessTemplate: UnwrapRef<typeof import('./src/types/retrospective')['ProcessTemplate']>
    ...
    readonly addWorkItemToSprint: UnwrapRef<typeof import('./src/api/sprints')['addWorkItemToSprint']>
    ...
    readonly createOrganization: UnwrapRef<typeof import('./src/api/organizations')['createOrganization']>
    ...
    readonly createRetrospective: UnwrapRef<typeof import('./src/api/retrospectives')['createRetrospective']>
    readonly createRetrospectiveItem: UnwrapRef<typeof import('./src/api/retrospectives')['createRetrospectiveItem']>
    ...
    readonly createTagImportJob: UnwrapRef<typeof import('./src/api/tag-import-jobs')['createTagImportJob']>
    ...
    readonly deleteRetrospectiveItem: UnwrapRef<typeof import('./src/api/retrospectives')['deleteRetrospectiveItem']>
    ...
    readonly displayError: UnwrapRef<typeof import('./src/composables/displayError')['displayError']>
    readonly effectScope: UnwrapRef<typeof import('vue')['effectScope']>
    readonly format: UnwrapRef<typeof import('./src/utils/date')['format']>
    readonly formatDistanceToNow: UnwrapRef<typeof import('./src/utils/date')['formatDistanceToNow']>
    ...
    readonly getBacklogLevelLabel: UnwrapRef<typeof import('./src/utils/work-item')['getBacklogLevelLabel']>
    ...
    readonly getDashboardData: UnwrapRef<typeof import('./src/api/dashboards')['getDashboardData']>
    readonly getInitials: UnwrapRef<typeof import('./src/utils/index')['getInitials']>
    readonly getJobStatusSeverity: UnwrapRef<typeof import('./src/utils/tag')['getJobStatusSeverity']>
    readonly getMoreTagsTooltip: UnwrapRef<typeof import('./src/utils/work-item')['getMoreTagsTooltip']>
    ...
    readonly getRetrospective: UnwrapRef<typeof import('./src/api/retrospectives')['getRetrospective']>
    readonly getStatusLabel: UnwrapRef<typeof import('./src/utils/work-item')['getStatusLabel']>
    readonly getStatusSeverity: UnwrapRef<typeof import('./src/utils/work-item')['getStatusSeverity']>
    readonly getTypeBackgroundColor: UnwrapRef<typeof import('./src/utils/work-item')['getTypeBackgroundColor']>
    ...
    readonly getWikiPageStats: UnwrapRef<typeof import('./src/api/wiki-pages')['getWikiPageStats']>
    readonly getWorkItem: UnwrapRef<typeof import('./src/api/work-items')['getWorkItem']>
    readonly getWorkItemsStats: UnwrapRef<typeof import('./src/api/work-items')['getWorkItemsStats']>
    ...
    readonly listOrganizations: UnwrapRef<typeof import('./src/api/organizations')['listOrganizations']>
    ...
    readonly listRetrospectives: UnwrapRef<typeof import('./src/api/retrospectives')['listRetrospectives']>
    readonly listSprints: UnwrapRef<typeof import('./src/api/sprints')['listSprints']>
    readonly listTagImportJobs: UnwrapRef<typeof import('./src/api/tag-import-jobs')['listTagImportJobs']>
    ...
    readonly updateProfilePicture: UnwrapRef<typeof import('./src/api/users')['updateProfilePicture']>
    ...
    readonly useOrganizationStore: UnwrapRef<typeof import('./src/stores/organization')['useOrganizationStore']>
    ...
    readonly useShortcuts: UnwrapRef<typeof import('./src/composables/useShortcuts')['useShortcuts']>
    ...
    readonly useWikiPageStats: UnwrapRef<typeof import('./src/queries/wiki-pages')['useWikiPageStats']>
    readonly useWikiPages: UnwrapRef<typeof import('./src/queries/wiki-pages')['useWikiPages']>
    readonly useWorkItemsStats: UnwrapRef<typeof import('./src/queries/work-items')['useWorkItemsStats']>

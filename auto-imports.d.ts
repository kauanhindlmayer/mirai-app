...
declare global {
  ...
  const deleteProject: (typeof import('./src/api/projects'))['deleteProject']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly createTagImportJob: UnwrapRef<
      (typeof import('./src/api/tag-import-jobs'))['createTagImportJob']
    >
    ...
    readonly deleteProject: UnwrapRef<(typeof import('./src/api/projects'))['deleteProject']>
    ...
    readonly getJobStatusSeverity: UnwrapRef<
      (typeof import('./src/utils/tag'))['getJobStatusSeverity']
    >
    ...
    readonly listTagImportJobs: UnwrapRef<
      (typeof import('./src/api/tag-import-jobs'))['listTagImportJobs']
    >
